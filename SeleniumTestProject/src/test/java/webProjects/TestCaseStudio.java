...
public class TestCaseStudio 
{
	...
	{
		ChromeOptions ca=new ChromeOptions();
		ca.addExtensions(new File("C:\\Users\\admin\\Downloads\\extension_1_6_5_0.crx"));
		ca.addArguments("---disable-notifications");
		 WebDriverManager.chromedriver().setup();
		 ChromeDriver driver = new ChromeDriver(ca);
		 ...
		 driver.switchTo().newWindow(WindowType.TAB);
		  ...
		  driver.manage().window().maximize();
		   ...
		   driver.findElement(By.xpath("//button[@type='submit']")).click();
			...
			driver.close();
			driver.switchTo().window(testCaseStudioWID);
			System.out.println(driver.getTitle());
			Thread.sleep(2000);
			driver.findElement(By.cssSelector("input[title='Edit test case name']")).sendKeys("LoginToApp");
			Thread.sleep(2000);
